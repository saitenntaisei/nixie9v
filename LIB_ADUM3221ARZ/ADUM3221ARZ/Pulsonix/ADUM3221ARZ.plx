...
//421424/700456/2.49/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ADUM3221ARZ" (originalName "ADUM3221ARZ")
	...
	(compDef "ADUM3221ARZ" (originalName "ADUM3221ARZ") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "VDD1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "VIA") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "VIB") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "VOA") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ADUM3221ARZ"))
		...
		(attr "Manufacturer_Part_Number" "ADUM3221ARZ")
		(attr "Mouser Part Number" "584-ADUM3221ARZ")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/ADUM3221ARZ?qs=WIvQP4zGanj4w8f7RObJXQ%3D%3D")
		(attr "Arrow Part Number" "ADUM3221ARZ")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/adum3221arz/analog-devices?region=nac")
		(attr "Mouser Testing Part Number" "")
		(attr "Mouser Testing Price/Stock" "")
		(attr "Description" "Analog Devices ADUM3221ARZ PCB SMT Digital Isolator, 2500 V, 8-Pin SOIC N")
		(attr "<Hyperlink>" "https://www.analog.com/media/en/technical-documentation/data-sheets/ADuM3220_3221.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "ADUM3221ARZ.stp")
