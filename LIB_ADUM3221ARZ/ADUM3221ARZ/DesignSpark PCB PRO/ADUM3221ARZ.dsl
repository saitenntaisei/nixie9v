...
(library Library_1
	...
	(compDef "ADUM3221ARZ" (originalName "ADUM3221ARZ") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "2" (pinName "VIA") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "VIB") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "7" (pinName "VOA") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.analog.com/media/en/technical-documentation/data-sheets/ADuM3220_3221.pdf")
		(attr "Height" "1.75 mm")
	)
